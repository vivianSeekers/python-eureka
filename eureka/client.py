...
class EurekaClient(object):
    def __init__(self, app_name, eureka_url=None, eureka_domain_name=None, host_name=None, data_center="",
                 vip_address=None, secure_vip_address=None, port=None, secure_port=None, use_dns=False, region=None,
    ...
    def register(self, initial_status="STARTING"):
        ...
        for eureka_url in self.eureka_urls:
            try:
                print "request eureka...."
                print eureka_url
                print urljoin(eureka_url, "/apps/%s" % self.app_name)
